    ...
    items: [
      {
        ...
        context: 'Mechanized',
        name: 'MLOps Platform',
        description: 'Plataforma end-to-end de MLOps para entrenar, desplegar y monitorear modelos de IA. Permite a los equipos gestionar el ciclo completo del modelo —dataset, entrenamiento, evaluación y puesta en producción— con flujos de trabajo automatizados y trazabilidad.',
      ...
      },
      {
        ...
        description: 'Herramienta de modernización de código legacy. Analiza, refactoriza y traduce aplicaciones mainframe/COBOL (sobre el ejemplo de IBM CardDemo) hacia stacks modernos manteniendo la lógica de negocio.',
      ...
      },
      {
        ...
        context: 'Mechanized',
        name: 'VMShift',
        description: 'Solución para mover máquinas virtuales a la plataforma de contenedores o cloud que el cliente elija. Automatiza el descubrimiento del workload, la evaluación de compatibilidad y la migración a AWS.',
        stack: ['Next.js', 'React', 'TypeScript'],
      ...
      },
      {
        ...
        context: 'Freelance',
        name: 'Pickly',
        description: 'Plataforma para crear y compartir encuestas, rankings, ratings, ruletas y torneos 1-vs-1. Sin registro: se comparte el link y se vota en segundos. Disponible como PWA instalable.',
      ...
      },
      {
        ...
        context: 'Freelance',
        name: 'ISEO RH',
        description: 'Sitio institucional de una consultora de Recursos Humanos para PyMEs. Comunica servicios, diagnóstico organizacional y la herramienta online de gestión de personal, con CTAs directos a WhatsApp.',
        stack: ['Next.js', 'React', 'TypeScript'],
        youtubeId: '',
        startSeconds: 0,
      ...
      },
      {
        ...
        name: 'Meme Maker',
        description: 'Generador de memes en el navegador. Subís una imagen, agregás texto editable y exportás el resultado. Pensado como experimento de manipulación de imagen del lado del cliente.',
      ...
      },
      {
        ...
        context: 'Bellolandia',
        name: 'Bellolandia',
        description: 'Sitio web del estudio de animación Bellolandia. Showcase de trabajos del estudio (videojuegos, series, animación) con catálogo de proyectos. Desarrollado en Webflow.',
        stack: ['Webflow'],
        youtubeId: '',
        startSeconds: 0,
